# Regression analysis for the relationship between the frequency of SVAs per chromosome and chromosome size

# This code conducts a simple linear regression analysis to determine whether there is 
# a significant relationship between the frequency of reference and non-reference SVAs per chromosome and chromosome size. 
...
Ref <- Sheet1$RefSVA.chr_Freq                # Frequency of reference SVAs per chromosome 
NonRef <- Sheet1$NonrefSVA.chr_Freq          # Frequency of non-reference SVAs per chromosome

# Regression analysis for frequency of reference SVAs per chromosome vs. chromosome length:

# Create regression model for total SVAs vs. chromosome length:
...
# Regression analysis for frequency of non-reference SVAs per chromosome vs. chromosome length:
