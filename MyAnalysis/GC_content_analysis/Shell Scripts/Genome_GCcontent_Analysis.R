...
# This code analysis the GC content of the hg19 genome in 20 kilobase (kb) windows.
...
locs <- read.delim("GC_content_analysis/Raw_data/genomeWindow_20kb.bed", header=F, sep="\t")
...
write.table(results, file = "GC_content_analysis/Results/GCcontent_wholeGenome_20kb_09022018.txt", sep="\t")
