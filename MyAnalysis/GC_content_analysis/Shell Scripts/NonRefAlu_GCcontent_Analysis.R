...
# This code analysis the GC content of non-reference Alus in 20 kilobase (kb) windows.
...
locs <- read.delim("GC_content_analysis/Raw_data/RTEdb_Alu_all_200bpmerged_20kbWindow.bed", header=F, sep="\t")
...
write.table(results, file = "GC_content_analysis/Results/RTEdb_AluY_GCresults20kb_26072019.txt", sep="\t")
