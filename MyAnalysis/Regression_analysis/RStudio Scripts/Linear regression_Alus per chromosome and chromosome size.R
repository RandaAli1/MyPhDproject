# Regression analysis for the relationship between the frequency of Alus per chromosome and chromosome size

# This code conducts a simple linear regression analysis to determine whether there is 
# a significant relationship between the frequency of reference and non-reference Alus per chromosome and chromosome size. 
...
Ref <- Sheet1$RefAlu.chr_Freq               # Frequency of reference Alus per chromosome 
NonRef <- Sheet1$NonRefAlu.chr_Freq         # Frequency of non-reference Alus per chromosome

# Regression analysis for frequency of reference Alus per chromosome vs. chromosome length:

# Create regression model for total Alus vs. chromosome length:
...
# Regression analysis for frequency of non-reference Alus per chromosome vs. chromosome length:
