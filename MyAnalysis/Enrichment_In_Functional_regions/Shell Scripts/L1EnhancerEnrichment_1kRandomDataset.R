...
# distribution against which the frequency of L1Hs elements in enhancer regions can be
...
write.table(Results1, file = "Enrichment_In_Functional_regions/Results/L1_1kRandomInsertions_Enhancerregions.txt", sep="\t", row.names=F,col.names=T, quote = F)
