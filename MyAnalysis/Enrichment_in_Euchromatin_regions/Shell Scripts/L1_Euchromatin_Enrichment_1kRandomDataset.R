# Analysing the distribution of a control dataset based on the size of non-reference L1Hs elements
...
# 10,211  random insertions corrosponding to the size of non-reference curated L1Hs elements. Next, the frequency 
...
# distribution against which the enrichment of L1Hs elements in euchromatin regions can be determined via the empirical P-value. 
...
write.table(Results2, file = "Enrichment_in_Euchromatin_regions/Results/RandomL1Hs_1k_H3K4Euchromatin.txt", sep="\t", row.names=F,col.names=T, quote = F)
