...
# This code analysis the GC content of reference SVAs in 20 kilobase (kb) windows.
...
locs <- read.delim("GC_content_analysis/Raw_data/SVAABC_refSVAs_20kbwindow.bed", header=F, sep="\t")
...
write.table(results, file = "GC_content_analysis/Results/RefSVAAC_GCresults20kb_29052019.txt", sep="\t")
