...
# distribution against which the frequency of AluY elements in each of the genomic regions can be
...
write.table(all_results, file = "Enrichment_In_Functional_regions/Results/AluY_1kRandomInsertionsIngeneregions.txt", sep="\t", row.names=F,col.names=T, quote = F)
