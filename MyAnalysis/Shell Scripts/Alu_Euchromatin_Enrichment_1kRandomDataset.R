...
# distribution against which the enrichment of AluY elements in euchromatin regions can be determined via the empirical P-value. 
...
write.table(Results2, file = "Enrichment_in_Euchromatin_regions/Results/RandomAlu_1k_H3K4Euchromatin.txt", sep="\t", row.names=F,col.names=T, quote = F)
