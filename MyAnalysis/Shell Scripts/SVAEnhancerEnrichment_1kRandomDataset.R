...
# distribution against which the frequency of SVA_E/F elements in enhancer regions can be
...
write.table(Results1, file = "Enrichment_In_Functional_regions/Results/SVAEF_1kRandomInsertions_Enhancerregions.txt", sep="\t", row.names=F,col.names=T, quote = F)
