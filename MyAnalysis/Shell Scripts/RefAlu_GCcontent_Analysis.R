...
# This code analysis the GC content of reference Alus in 20 kilobase (kb) windows.
...
locs <- read.delim("GC_content_analysis/Raw_data/AluJ_refAlus_20kbwindow.bed", header=F, sep="\t")
...
write.table(results, file = "GC_content_analysis/Results/RefAluJ_GCresults20kb_29052019.txt", sep="\t")
